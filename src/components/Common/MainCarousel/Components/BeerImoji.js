...
const BeerImoji = ({ rate }) => {
  const fillBeer = (
    <img src="/images/beer_100.png" className="fulllBeer" art="beer" />
  );
  const halfBeer = (
    <img src="/images/beer_50.png" className="fulllBeer" art="beer" />
  );
  const empty = <img src="/images/beer.png" className="fulllBeer" art="beer" />;
